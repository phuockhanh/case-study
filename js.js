...
let producSlide1 = new slideImg('image/img1-slide-footer.jpg','Kaffee-Röstungen: So röstet man Bohnen weltweit am liebsten','04<br>Mrz','Heute nehme ich euch mit auf eine kleine, gedankliche Weltreise, denn: Wenn wir schon nicht...');
let producSlide2 = new slideImg('image/img2-slide-footer.jpg','Faschings-Krapfen mit Kaffeefüllung','16<br>Feb','Auch, wenn wir Fasching dieses Jahr etwas anders feiern als sonst – wir finden: Faschings-Krapfen...');
let producSlide3 = new slideImg('image/img3-slide-footer.jpg','3 Möglichkeiten, um eure Liebe mit Kaffee zu zeigen','08<br>Feb','Es ist wieder soweit, der Valentinstag steht vor der Türe! Für den Tag der Liebenden...');
let producSlide4 = new slideImg('image/img4-slide-footer.jpg','Millionaire’s Mule Cocktail mit Cold Brew Sparkling Ginger Lemon','29<br>Jan','Happy Friday, liebe Kaffeeliebhaber:innen! Wenn wir nicht in die Bar können, kommt die Bar einfach...');
let producSlide5 = new slideImg('image/img5-slide-footer.jpg','Unsere Kaffeetrends 2021','22<br>Jan','Auch wenn die meisten Cafés gerade geschlossen haben oder Coffee To Go anbieten, hat sich...');
let producSlide6 = new slideImg('image/img6-slide-footer.jpg','Black Coffee Week: Der perfekte Espresso','23<br>Nov','Hoch die Espresso-Tassen, diese Woche zelebrieren wir bei J. Hornig die Black Coffee Week! Bis...');
let producSlide7 = new slideImg('image/img7-slide-footer.jpg','Wir feiern den Tee: Ein bisschen Melancholie aus der Tasse','04<br>Nov','Unsere neuen biologisch abbaubaren Kapseln sind nicht nur von außen hübsch: Die verschiedenen bunten Zertifizierungen,...');
let producSlide8 = new slideImg('image/img8-slide-footer.jpg','Die Zertifizierungen für unsere J. Hornig Kapseln: Was steckt dahinter?','28<br>Okt','Unsere neuen biologisch abbaubaren Kapseln sind nicht nur von außen hübsch: Die verschiedenen bunten Zertifizierungen,...');
let producSlide9 = new slideImg('image/img9-slide-footer.jpg','Kaffee-Röstungen: So röstet man Bohnen weltweit am liebsten','04<br>Mrz','Heute nehme ich euch mit auf eine kleine, gedankliche Weltreise, denn: Wenn wir schon nicht...');
